...
public class AlgorithmeDijkstra<E> implements AlgorithmeChemin<E> {
    ...
    public List<Noeud<E>> trouverChemin(Graphe<E> graphe, Noeud<E> depart, Noeud<E> arrivee) {
        ...
        PriorityQueue<Noeud<E>> filePriorite = new PriorityQueue<>(Comparator.comparing(listeCouts::get));
        ...
        while (!filePriorite.isEmpty()) {
            ...
            // Si le noeud de ref est le noeud d'arrivee, on arrete l'algo vu qu'on a déjà
            // trouvé le noeud d'arrivee
